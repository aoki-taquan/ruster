...
| ICMP4-012H4 reverse resolution continuation | RFC 1812 §4.3.2.4, §§5.2.4.1–5.2.4.3 | `reverse_miss_survives_arp_then_learning_queues_once` | implemented | reverse missはholdなし通常ARP、candidateは残し、learning後fresh originalなしでCode 1 queue。recursive failureはretire |
