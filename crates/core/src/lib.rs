...
pub use resolution::{
    ...
    NoResolutionFailureTrace, NoResolutionTimerTrace, ResolutionActionSlot, ResolutionCounters,
    ResolutionDatagramHoldSlot, ResolutionFailureCapture, ResolutionFailureCounters,
    ...
    ResolutionGenerationToken, ResolutionHoldCounters, ResolutionHoldDisposition, ResolutionPhase,
