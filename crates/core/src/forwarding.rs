...
impl ValidatedForwardingOwner {
    ...
    pub fn new(
        ...
        let validated = ForwardingSnapshot::with_ipv4_origin_policy(
            &routes,
            &interfaces,
            &neighbors,
            &local_ipv4,
...
fn next_publication_nonce() -> Option<u64> {
    ...
    static NEXT_PUBLICATION_NONCE: AtomicU64 = AtomicU64::new(1);
